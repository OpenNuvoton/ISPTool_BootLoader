...
CDialogChipSetting_M460::CDialogChipSetting_M460(unsigned int uProgramMemorySize, unsigned int uFlashPageSize, unsigned int uChipSeries, CWnd* pParent /*=NULL*/)
...
BOOL CDialogChipSetting_M460::OnInitDialog()
{
	...
	if (m_uShowFlag & 0x01)
	{
		...
		//if ((m_uChipSeries == PROJ_M460HD) || (m_uChipSeries == PROJ_M460LD))
		//{
